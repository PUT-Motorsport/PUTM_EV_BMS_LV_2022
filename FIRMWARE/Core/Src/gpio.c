...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, CAN_STANDBY_Pin|EFUSE_Pin|RED_Pin|GREEN_Pin
  ...
  /*Configure GPIO pins : EFUSE_Pin RED_Pin GREEN_Pin YELLOW_Pin */
  GPIO_InitStruct.Pin = EFUSE_Pin|RED_Pin|GREEN_Pin|YELLOW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
